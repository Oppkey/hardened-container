---
title: "Blog Posts"
description: "Latest posts on hardened runtimes, container isolation, and security"
---

## Blog Posts

Our latest technical deep-dives on hardened runtimes, container isolation, and security topics.

### Latest Posts

- **[Runtime Isolation: Hypervisor vs. OSS Runtimes](/posts/runtime-isolation-comparison.qmd)** - Comparing Edera's paravirtualized hypervisor with Kata Containers and gVisor
- **[Base Images: Full Kernel vs. Stripped-Down](/posts/base-images-comparison.qmd)** - Edera's full kernel approach vs. AWS Bottlerocket and Google COS
